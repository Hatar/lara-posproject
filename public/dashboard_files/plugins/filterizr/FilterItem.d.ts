...
export default class FilterItem {
    ...
    /**
     * Returns all users of the grid items data-category attribute
     * with a regexp regarding all whitespace.
     * @return {String[]} an array of the users the item belongs to
     */
    getusers(): string[];
    /**
     * Returns the value of the sort attribute
     * @param sortAttribute "index", "sortData" or custom category data-attribute by which to sort
     */
